# Calculates OIL confidence indicator
...
list_of_files <- list.files(path = "data/OIL_WINDOWS/",
...
for (i in 4:11){
  ...
  jpeg(paste(folder,"plots/",names(plotdat[i]),"_",filesname,".jpeg",sep=""),height = 1080,width=1920) 
...
write.csv(a,paste(folder,"OIL_ANALYSIS.csv",sep=""))
